...
<fieldset >
    <!--Judul pada fieldset-->
    <legend align="center">Agen Buku Mang Kalam</legend>
    <div class="nav">
        <a href="index.php">Home</a>
        <a href="admin.php">Admin</a>
        <a href="pengadaan.php">Pengadaan</a>
    </div>
    <h3 align="center">Selamat Datang Di Agen Buku Terpercaya</h3>
   ...
   <center><a href="tambah_form.html">Tambah Data</a></center>
    ...
    <table class="table-home">
        ...
        <tbody>
            ...
            $query = "SELECT * FROM tb_agen WHERE ID_Buku like '%".$kata_cari."%' OR
            Nama_Buku like '%".$kata_cari."%' OR
            Kategori like '%".$kata_cari."%' ORDER BY ID_Buku ASC";
            } else {
            //jika tidak ada pencarian, default yang dijalankan query ini
            $query = "SELECT * FROM tb_agen ORDER BY ID_Buku ASC";
            }
