...
<fieldset >
    <!--Judul pada fieldset-->
    <legend align="center">Toko Buku Mang Kalam</legend>
    <div class="nav">
   ...
   <center><a href="tambah_penerbit.html">Tambah Data</a></center>
    ...
    <table class="table-home">
        ...
        <tbody>
            ...
            $query = "SELECT * FROM tb_agenpenerbit WHERE ID_Penerbit like '%".$kata_cari."%' OR
            Nama like '%".$kata_cari."%' OR
            Telepon like '%".$kata_cari."%' ORDER BY ID_Penerbit ASC";
            } else {
            //jika tidak ada pencarian, default yang dijalankan query ini
            $query = "SELECT * FROM tb_agenpenerbit ORDER BY ID_Penerbit ASC";
            }
